...
public class UserCheckManager implements UserCheckService {
    ...
    public Result isValidPassword(String password) {
        if (password == null || !Pattern.matches(UTILS.CONSTANTS.REGEX_PASSWORD, password)) {
    ...
    public Result isValidWebsite(String website) {
        if (website == null || !Pattern.matches(UTILS.CONSTANTS.REGEX_WEBSITE, website))
    ...
    public Result isValidWebsiteDiffDomain(String email, String website) {
        if (email.split("@")[1].equals(website)) {
