...
public class HEFKPSPublicSoap
{
    ...
    public HEFKPSPublicSoap(){}

    public HEFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HEFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HEFExtendedSoapSerializationEnvelope envelope= new HEFExtendedSoapSerializationEnvelope(HEFExtendedSoapSerializationEnvelope.VER11);
