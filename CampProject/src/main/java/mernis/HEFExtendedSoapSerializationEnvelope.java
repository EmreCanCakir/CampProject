...
public class HEFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HEFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new HEFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HEFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HEFDateTimeConverter dateTimeConverter = new HEFStandardDateTimeConverter();

    public HEFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HEFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HEFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HEFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HEFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HEFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
